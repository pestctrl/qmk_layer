...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [8] = LAYOUT_moonlander(
    MU_ON,          KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, TOGGLE_LAYER_COLOR,RGB_TOG,        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
    MU_OFF,         DYN_REC_START2, KC_MS_BTN2,     KC_MS_UP,       KC_MS_BTN1,     DYN_REC_START1, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, RGB_VAI,        RGB_VAD,        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
    MU_MOD,         DYN_MACRO_PLAY2,KC_MS_LEFT,     KC_MS_DOWN,     KC_MS_RIGHT,    DYN_MACRO_PLAY1,KC_TRANSPARENT,                                                                 KC_TRANSPARENT, RGB_MOD,        RGB_SPI,        RGB_SPD,        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
